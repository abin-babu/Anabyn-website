      ...
      <div className="relative w-12 h-12 flex-shrink-0">
        <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
          ...
          <g transform="translate(28, 40) scale(0.8)">
            ...
            <path d="M10.5 14.6c1.1-.1 2.1.2 2.9.9l4.1 3.5 2.1-2.1c.8-.8 2-.8 2.8 0l4.9 4.9c.8.8.8 2 0 2.8l-4.9 4.9c-.8.8-2 .8-2.8 0l-2.1-2.1-4.1 3.5c-.8.7-1.8 1-2.9.9-1.1-.1-2-.6-2.6-1.5l-2.8-4.9c-.6-.9-1.6-1.4-2.7-1.5z" fill="#C8A020" />
          </g>
        </svg>
      </div>
